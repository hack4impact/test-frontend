...
export default function Initiative(
  ...
  return (
    <Card
      ...
      } className={cn("perspective[100px] transition-transform ease-out hover:[transform:rotateX(var(--x-rotation))_rotateY(var(--y-rotation))_scale(1.05)] w-1/3 min-h-100 gap-0 rounded-md shadow-none border-none hover:drop-shadow-md transition-all", bg, color)}>
      <CardHeader>
